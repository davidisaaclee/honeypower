...
(function() {
  var Entity, Model, Scene, Set, Timeline, TimelinesTable, _, createStore, u,
  ...
  Scene = (function(superClass) {
    ...
    Scene.empty = Object.freeze(Scene.make(Set.withHashFunction(Entity.getId), Set.withHashFunction(Timeline.id.get)));
    ...
    Scene.progressTimeline = function(scene, timelineId, delta) {
      ...
      progressEntity = function(s, eId) {
        return Scene.mutateEntity(s, eId, function(e) {
          var currentProgress, d;
          currentProgress = Entity.getProgressForTimeline(e, timelineId);
          d = (function() {
            switch (false) {
              case !((currentProgress + scaledDelta) > 1):
                return 1 - currentProgress;
              case !((currentProgress + scaledDelta) < 0):
                return 0 - currentProgress;
              default:
                return scaledDelta;
            }
          })();
          return Entity.progressTimeline(e, timelineId, d);
        });
      };
      affectedEntityIds = Scene.getAllEntities(scene).filter(function(entity) {
