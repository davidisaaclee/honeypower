...
(function() {
  ...
  Vector2 = (function(superClass) {
    ...
    Vector2.x = Lens.fromPath('x');

    Vector2.y = Lens.fromPath('y');

    Vector2.magnitude = new Lens(function(v) {
      return Math.sqrt(Vector2.squaredMagnitude(v));
    }, function(v, m) {
      return Vector2.scale(Vector2.normalize(v), m);
    });
    ...
    Vector2.normalize = function(v) {
      return Vector2.scale(v, 1 / Vector2.magnitude.get(v));
    };
